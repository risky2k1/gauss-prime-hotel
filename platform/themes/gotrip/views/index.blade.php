    ...
    <div class="container">
        <div class="row y-gap-20">
            <div data-anim="slide-up" class="col-md-6">
                ...
                <div class="ctaCard -type-1 rounded-4 ">
                    <div class="ctaCard__image ratio ratio-63:55">
                        <img class="img-ratio js-lazy" src="#" data-src="{{ Theme::asset()->url('img/backgrounds/1.png') }}" alt="image">
                    </div>
            ...
            <div data-anim="slide-up delay-1" class="col-md-6">
                ...
                <div class="ctaCard -type-1 rounded-4 ">
                    <div class="ctaCard__image ratio ratio-63:55">
                        <img class="img-ratio js-lazy" src="#" data-src="{{ Theme::asset()->url('img/backgrounds/2.png') }}" alt="image">
                    </div>
    ...
    <div data-anim-wrap class="container">
        <div class="row y-gap-20 justify-between">
            ...
            <div data-anim-child="slide-up delay-1" class="col-lg-3 col-sm-6">
                ...
                <div class="featureIcon -type-1 ">
                    <div class="d-flex justify-center">
                        <img src="#" data-src="{{ Theme::asset()->url('img/featureIcons/1/1.svg') }}" alt="image" class="js-lazy">
                    </div>
            ...
            <div data-anim-child="slide-up delay-2" class="col-lg-3 col-sm-6">
                ...
                <div class="featureIcon -type-1 ">
                    <div class="d-flex justify-center">
                        <img src="#" data-src="{{ Theme::asset()->url('img/featureIcons/1/2.svg') }}" alt="image" class="js-lazy">
                    </div>
            ...
            <div data-anim-child="slide-up delay-3" class="col-lg-3 col-sm-6">
                ...
                <div class="featureIcon -type-1 ">
                    <div class="d-flex justify-center">
                        <img src="#" data-src="{{ Theme::asset()->url('img/featureIcons/1/3.svg') }}" alt="image" class="js-lazy">
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="row items-center x-gap-30 y-gap-20">
                                <div class="col-auto">
                                    <img src="#" data-src="{{ Theme::asset()->url('img/avatars/1.png') }}" alt="image" class="js-lazy">
                                </div>
        ...
        <div class="row y-gap-30 pt-40">
                ...
                <a href="" class="blogCard -type-1 d-block ">
                    <div class="blogCard__image">
                        <div class="ratio ratio-4:3 rounded-4 rounded-8">
                            <img class="img-ratio js-lazy" src="#" data-src="{{ Theme::asset()->url('img/blog/1.png') }}" alt="image">
                        </div>
                    </div>
            ...
            <div data-anim-child="slide-left delay-2" class="col-lg-4 col-sm-6">
                ...
                <a href="" class="blogCard -type-1 d-block ">
                    <div class="blogCard__image">
                        <div class="ratio ratio-4:3 rounded-4 rounded-8">
                            <img class="img-ratio js-lazy" src="#" data-src="{{ Theme::asset()->url('img/blog/2.png') }}" alt="image">
                        </div>
                    </div>
            ...
            <div data-anim-child="slide-left delay-3" class="col-lg-4 col-sm-6">
                ...
                <a href="" class="blogCard -type-1 d-block ">
                    <div class="blogCard__image">
                        <div class="ratio ratio-4:3 rounded-4 rounded-8">
                            <img class="img-ratio js-lazy" src="#" data-src="{{ Theme::asset()->url('img/blog/3.png') }}" alt="image">
                        </div>
                    </div>
