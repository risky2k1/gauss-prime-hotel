                                                            ...
                                                            <div class="tabs__content js-tabs-content">
                                                                <div class="tabs__pane -tab-item-1 is-tab-el-active">
                                                                    <div class="mega__content">
                                                                        ...
                                                                        <div class="mega__image d-flex relative">
                                                                            <img src="#" data-src="{{ Theme::asset()->url('img/backgrounds/7.png') }}" alt="image" class="rounded-4 js-lazy">
                                                                ...
                                                                <div class="tabs__pane -tab-item-2">
                                                                    <div class="mega__content">
                                                                        ...
                                                                        <div class="mega__image d-flex relative">
                                                                            <img src="{{ Theme::asset()->url('img/backgrounds/7.png') }}" alt="image" class="rounded-4">
                                ...
                                <div class="row x-gap-20 items-center xxl:d-none">
                                    ...
                                    <div class="col-auto">
                                        <button class="d-flex items-center text-14 text-white" data-x-click="lang">
                                            <img src="{{ Theme::asset()->url('img/general/lang.png') }}" alt="image" class="rounded-full mr-10">
